...
===================================
Chakshuh - Retrained Clinical Model Inference & Multi-Cohort Evaluation
...
OUTPUT_XLSX = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Chakshuh_24403_Retrained_Clinical_Predictions.xlsx")
OUTPUT_CSV = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Chakshuh_24403_Retrained_Clinical_Predictions.csv")
REPORTS_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "dr-screening-sih", "reports")
REPORTS_XLSX = os.path.join(REPORTS_DIR, "Chakshuh_24403_Retrained_Clinical_Predictions.xlsx")
...
def main():
    print(f"================================================================================")
    print(f"CHAKSHUH - 24,403-IMAGE RETRAINED CLINICAL MODEL INFERENCE & EXCEL GENERATOR")
    ...
    title_cell.value = "CHAKSHUH - RETRAINED CLINICAL VALIDATION DOSSIER (24,403 IMAGES)"
    ...
    cohort_title.value = "CHAKSHUH - INDIVIDUAL COHORT VALIDATION PERFORMANCE (11 BENCHMARK DATASETS)"
    ...
    PUBLIC_XLSX = os.path.join(PUBLIC_DIR, "Chakshuh_24403_Retrained_Clinical_Predictions.xlsx")
